                            ...
                            <form action="" class="form-inline" method="post">
                                <div class="input-group mb-2 mr-sm-2 list-width">
                                    <select name="customer_id" class="form-control select2" id="customer_id"  tabindex="-1" aria-hidden="true">
                                        <option value="">@lang('Select Customer Name')</option>
                                ...
                                <button type="submit" id="btn-filter-pur" class="btn btn-success mb-2">@lang('Find')</button>
                            </form>
                        </div>
                    ...
                    <table class="table" width="99%" align="center" cellpadding="5" cellspacing="5" border="2">
                        <thead>
                            <tr align="center" class="">
                                <td colspan="7">
                                    <font size="+1">
                                        <strong>@lang('Customer Ledger- Customer Receivable') ( <span class="text-">2022-08-15</span> To <span class="text"> 2022-08-15</span>)</strong>
                                    </font>
                                </td>
                            </tr>
                            <tr>
